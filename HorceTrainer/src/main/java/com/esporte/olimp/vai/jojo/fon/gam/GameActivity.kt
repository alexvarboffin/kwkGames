                ...
                Scaffold(
                    ...
                    NavHost(
                        ...
                        composable(Screen.Trainings.route) {
                            val viewModel: TrainingsViewModel = viewModel(factory = ViewModelFactory(
                                appContainer
                            )
                            )
                        ...
                        composable(Screen.AddHorse.route) {
                            val viewModel: AddHorseViewModel = viewModel(factory = ViewModelFactory(
                                appContainer
                            )
                            )
                            AddHorseScreen(
                        ...
                        composable(Screen.NewTraining.route) {
                            val viewModel: NewTrainingViewModel = viewModel(factory = ViewModelFactory(
                                appContainer
                            )
                            )
                            NewTrainingScreen(
                        ...
                        composable(Screen.AddHealthData.route) {
                            val viewModel: AddHealthDataViewModel = viewModel(factory = ViewModelFactory(
                                appContainer
                            )
                            )
                            AddHealthDataScreen(
