...
import com.walhalla.sdk.data.repository.UserProgressRepositoryImpl
...
import com.walhalla.sdk.domain.repository.UserProgressRepository0
...
val appModule = module {
    ...
    //sdk
    single<UserProgressRepository0> { UserProgressRepositoryImpl(androidContext()) }
