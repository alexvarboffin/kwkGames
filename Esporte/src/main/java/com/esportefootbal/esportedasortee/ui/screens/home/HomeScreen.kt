...
fun HomeScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Image(
            painter = painterResource(id = R.drawable.ic_feeld),
...
//            }
            ...
            Row(
                ...
                BeautifulButton(onClick = { openInCustomTab(context = context,
                    "https://esporhp.top/Privacy5") }, text = "Privacy Policy")
                BeautifulButton(onClick = { openInCustomTab(context, "https://esporhp.top/FAQ5") }, "FAQ")
            }
        }
    }
}
...
fun LevelItem(
    ...
    Box(
        modifier = Modifier
            ...
            .then(
                if (isLocked) Modifier.graphicsLayer(
