...
public class SoundAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        playButton.setOnClickListener(v -> ((MainActivity) context).playSound(sound.getId()));
        ...
        deleteButton.setOnClickListener(v -> new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.button_ok, (dialog, which) -> ((MainActivity) context).removeSound(position))
