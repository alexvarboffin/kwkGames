...
import com.vai.vaidebet.vaibrazil.presentation.GameViewModel
import com.vai.vaidebet.vaibrazil.presentation.GameViewModelFactory
import kotlin.random.Random

@Composable
fun GameScreen(level: Int, navController: NavController, gameViewModel: GameViewModel = viewModel(factory = GameViewModelFactory(level))) {
